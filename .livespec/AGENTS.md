...
generated: 2025-10-10T17:30:00Z
...
**Outputs**: specs/3-behaviors/, specs/contracts/
...
specs/requirements.spec.md (What - High-Level Requirements)
  ↓ constrains
specs/constraints.spec.md → specs/2-strategy/architecture.spec.md
...
specs/2-strategy/architecture.spec.md
  ↓ defines approach
specs/3-behaviors/*.spec.md (What - Detailed)
  ↓ requires
code (Implementation)
```
